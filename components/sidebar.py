...
# ========= Layout ========= # nome da sua ecolha para o app
layout = dbc.Card([
                html.H1("JOVEM BIKE", className="text-primary"),
                html.P("By T.M.S", className="text-info"),
                html.Hr(),


    # Seção PERFIL ------------------------
                dbc.Button(id='botao_avatar',
                    children=[html.Img(src="/assets/jovembike.png", id="avatar_change", alt="Avatar", className='perfil_avatar'),
                ...
                dbc.Modal([
                    ...
                    dbc.ModalBody([
                        dbc.Row([
                            dbc.Col([
                                dbc.Card([
                                    dbc.CardImg(src="/assets/jovembike.png", className='perfil_avatar', top=True),
                                    dbc.CardBody([
                                        html.H4("Perfil Da Loja", className="card-title"),
                                        html.P(
                                            "Um Card com exemplo do perfil da Loja. Texto para preencher o espaço",
                                            className="card-text",
                                        ),
    ...
    # Seção + NOVO ------------------------Botões
            ...
            # Modal ao apertar + lucros abre uma caixa #
            html.Div([
                dbc.Modal([
                    dbc.ModalHeader(dbc.ModalTitle("Adicionar Lucros")),
                    dbc.ModalBody([
                        dbc.Row([
                            dbc.Col([
                                    dbc.Label("Descrição: "),
                                    dbc.Input(placeholder="Ex.: Ganhos de vendas ...", id="txt-receita"),
                            ], width=6), 
                            dbc.Col([
                                    dbc.Label("Valor: "),
                            ...
                            dbc.Col([
                                ...
                                dbc.Checklist(
                                    options=[{"label": "Foi recebida", "value": 1},
                                        {"label": "Lucro Recorrente", "value": 2}],
                                    value=[1],
                        ...
                        dbc.Row([
                            dbc.Accordion([
                                    ...
                                    dbc.ModalFooter([
                                        dbc.Button("Adicionar Lucro", id="salvar_receita", color="success"),
            ...
            ### Modal ao apertar + despesas abre uma caixa  ###
            dbc.Modal([
                ...
                dbc.ModalBody([
                    dbc.Row([
                        dbc.Col([
                                dbc.Label("Descrição: "),
                                dbc.Input(placeholder="Ex.: compras diversas...", id="txt-despesa"),
                        ], width=6), 
                        dbc.Col([
                                dbc.Label("Valor: "),
...
# Seção NAV ------------------------ Botões Dashboard e Extratos
            html.Hr(),
            dbc.Nav(
                [
...
def salve_form_despesa(n, valor, switches, descricao, date, txt, dict_despesas):
    ...
    if n and not (valor == "" or valor == None):
        ...
        # Verifica se a variável categoria está definida e tem um valor
        if 'categoria' in locals() and type(categoria) == list:
            categoria = categoria[0]
        else:
            categoria = None  # Defina um valor padrão se a variável categoria não estiver definida
